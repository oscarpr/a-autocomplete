...
[travis-badge]: https://travis-ci.org/filipesilva/angular-a-autocomplete.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-a-autocomplete
...
1. Create a project folder (you can call it `a-autocomplete` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-a-autocomplete.git
cd angular-a-autocomplete
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-a-autocomplete/archive/master.zip)
...
Use your editor to search the project for all instances of `a-autocomplete` and change it
